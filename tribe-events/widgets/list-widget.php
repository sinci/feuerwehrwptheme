	...
	<ol class="tribe-list-widget">
		...
		foreach ( $posts as $post ) :
			...
			<li class="tribe-events-list-widget-events <?php tribe_events_event_classes() ?>">
                ...
                echo '<div class="uk-float-left"><a href="' . tribe_get_event_link() . '"><img src="[image url goes here]" alt="' .  the_title() . '" /></a></div>';
                } 
                else { echo tribe_event_featured_image(null,'thumbnail'); } 
                ?>
